...
class AdministradoresManager extends LitElement {
    ...
    static properties = {
        ...
        editingAdministrador: { type: Object },
        saving: { type: Boolean }
    };
    ...
    constructor() {
        ...
        this.editingAdministrador = null;
        this.saving = false;
    ...
    openEditModal(e) {
        this.editingAdministrador = e.detail.item;
        this.showModal = true;
    }
    ...
    async handleSubmit(e) {
        ...
        try {
            if (this.editingAdministrador) {
                await apiService.updateAdministrador(this.editingAdministrador.IdAdministrador, data);
                this.showNotification('Administrador actualizado exitosamente', 'success');
            } else {
                await apiService.createAdministrador(data);
    ...
    renderModal() {
        ...
        const admin = this.editingAdministrador;
                ...
                <div class="modal-content" @click=${(e) => e.stopPropagation()}>
                    ...
                    ${!admin ? html`
                        <div class="alert alert-info">
                            ...
                            Se creará solo el registro del administrador. Para crear un usuario de acceso, debe registrarse desde la pantalla de registro.
                        </div>
                    ` : ''}
