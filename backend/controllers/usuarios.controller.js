        ...
        const usuariosFormateados = usuarios.map(u => {
            ...
            switch(u.Rol) {
                case 'MEDICO':
                    ...
                    detalles = { especialidad: u.EspecialidadMedico, idMedico: u.IdMedico };
                    break;
                case 'PACIENTE':
                    nombre = u.NombrePaciente;
                    detalles = { cedula: u.Cedula, idPaciente: u.IdPaciente };
                    break;
                case 'ADMIN':
                    nombre = u.NombreAdmin;
                    detalles = { correo: u.Correo, idAdministrador: u.IdAdministrador };
                    break;
            }
